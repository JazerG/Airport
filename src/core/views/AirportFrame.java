...
// Para generar combos
        ...
        try {
            ...
            if (resp.getStatus() == Status.CREATED) {
                ...
                for (Location loc : locationController.getLocations()) {
                    ...
                    jComboBox2.addItem(airportId);
                    jComboBox3.addItem(airportId);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        Location departure = new core.models.storage.LocationStorage().getById(departureLocationId);
        Location arrival = new core.models.storage.LocationStorage().getById(arrivalLocationId);

        Location scale = null;
        if (scaleLocationId != null && !scaleLocationId.equalsIgnoreCase("Ninguna")) {
            scale = new core.models.storage.LocationStorage().getById(scaleLocationId);
        }

        core.controllers.FlightController controller = new core.controllers.FlightController();
        Response status = controller.createFlight(
                id, plane, departure, arrival, scale,
                departureDate, hoursDurationsArrival, minutesDurationsArrival,
    ...
    private void Add_To_FlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add_To_FlightActionPerformed
        try {
            ...
            if (resp.getStatus() == Status.OK) {
                ...
                // 5) Refrescar listas y tablas 
                this.passengers = passengerController.getPassengers();
                this.flights = flightController.getFlights();
                //refreshPassengerTable();   // método que recarga tu JTable de pasajeros
                //refreshFlightTable();      // método que recarga tu JTable de vuelos
    ...
    private void DelayFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DelayFlightActionPerformed
        try {
            // 1) Leemos el ID de vuelo y el tiempo de retraso
            ...
            // 2) Delegamos la lógica al Controller
            ...
            if (resp.getStatus() == Status.OK) {
                ...
                // 4) Refrescamos datos y UI
                this.flights = flightController.getFlights();
                //refreshFlightTable();   // recarga tu JTable de vuelos
